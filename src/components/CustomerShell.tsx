...
// Location switching (which restaurant an order is for) lives as buttons on the
// Bestellingen page itself, above "Deze week". Managing locations — adding one,
// editing name/KvK/address, delivery addresses — lives on Mijn account. This shell
// is just navigation.
