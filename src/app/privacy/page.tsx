...
export const metadata = { title: `Privacybeleid — ${bakeryConfig.businessName}` };

// Public privacy policy (no auth) — referenced from the login page, the customer portal,
// and the account-activation consent checkbox, and used as the privacy URL for the
...
export default function PrivacyPage() {
  const bakery = bakeryConfig.businessName;
  const address = bakeryConfig.bakeryAddress;
  ...
  return (
    <div style={{ minHeight: "100vh", background: "var(--bg)", padding: "2.5rem 1.25rem" }}>
      <div style={{ maxWidth: 720, margin: "0 auto", background: "var(--surface)", border: "1px solid var(--border)", borderRadius: 16, padding: "2.5rem" }}>
        ...
        <p style={{ fontSize: 13, color: "var(--text-muted)", margin: "0 0 4px" }}>{bakery}</p>
        <p style={{ fontSize: 12, color: "var(--text-subtle)", margin: 0 }}>Laatst bijgewerkt: 11 juli 2026</p>

        <h2 style={h2}>1. Wie zijn wij</h2>
        <p style={p}>
          {bakery} ({address}) is verantwoordelijk voor de verwerking van uw persoonsgegevens zoals
          beschreven in dit beleid. Voor het beheer van bestellingen, bezorging en facturatie maken
          wij gebruik van het Sirdough-platform.
        </p>

        <h2 style={h2}>2. Welke gegevens wij verzamelen</h2>
        <ul style={{ paddingLeft: 20, margin: "0 0 8px" }}>
          <li style={li}>Naam en (bedrijfs)contactgegevens: e-mailadres, telefoonnummer en bezorg-/afhaaladres;</li>
          ...
          <li style={li}>Factuurgegevens en betaalgegevens die nodig zijn voor facturatie;</li>
        ...
        <p style={p}>
          Wij verzamelen gegevens die u zelf invoert wanneer u een account activeert of een bestelling
          plaatst of wijzigt, en gegevens die de bakkerij invoert om uw bestellingen en facturen te
          kunnen verwerken. Adressen worden geocodeerd via de openbare adresvoorziening (PDOK) om de
          bezorging te plannen.
        </p>
        ...
        <p style={p}>Wij delen uw gegevens uitsluitend met de partijen die nodig zijn om onze dienst te leveren:</p>
        <ul style={{ paddingLeft: 20, margin: "0 0 8px" }}>
          ...
          <li style={li}><strong>Onze hostingprovider</strong> — voor de opslag en verwerking van gegevens in een datacenter binnen de EU.</li>
        </ul>
        ...
        <p style={p}>
          ...
          bewaren wij gedurende de wettelijke fiscale bewaartermijn van 7 jaar. Daarna, of eerder op
        ...
        <p style={p}>
          Alle verbindingen verlopen uitsluitend over een versleutelde HTTPS/TLS-verbinding.
          Wachtwoorden worden gehasht opgeslagen, de toegang is beveiligd met authenticatie en
          rolgebaseerde autorisatie, en de gegevens van elke bakkerij staan in een gescheiden database.
        </p>
        ...
        <p style={p}>
          ...
          intrekken en een verzoek tot verwijdering indienen. Neem daarvoor contact op met de bakkerij
          (zie hieronder). Wij reageren binnen de wettelijke termijn en verwijderen uw gegevens, tenzij
          een wettelijke bewaarplicht dit tijdelijk in de weg staat.
        </p>

        <h2 style={h2}>9. Contact</h2>
        <p style={p}>
          Voor vragen over dit privacybeleid of een verzoek met betrekking tot uw gegevens kunt u
          contact opnemen met {bakery}, {address}.
        </p>
